"""
align_and_merge_meshes.py

This script aligns and merges multiple meshes using manually selected correspondences. It uses SVD (Kabsch algorithm) to compute the optimal rigid transformation and applies it to each mesh before merging.
"""
import os
import pickle
import numpy as np
